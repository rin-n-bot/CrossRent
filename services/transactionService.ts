// Transaction service handling rent requests, approvals, and status updates
...
// Extract rental period from item with fallback values
...
// Extract rental price from item with fallback values
...
// Create rent request transaction and update item status
...
// Update transaction status and sync item availability
...
// Mark item as deleted and update all associated transactions
...
// Remove transaction record and log action
