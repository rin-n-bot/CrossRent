...
// Utility to scale sizes based on screen width, using 390 as base width
const { width } = Dimensions.get('window');
const scaleW = (size: number) => (width / 390) * size;


// Props for the SplashAnimation component
interface Props {
...
export const SplashAnimation = ({
  ...
  // Logo and spinner centered in the overlay
  return (
    <Animated.View
...
// Styles for the SplashAnimation component
